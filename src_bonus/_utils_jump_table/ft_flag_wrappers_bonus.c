...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_flag_wrappers_bonus.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dlesieur <dlesieur@student.42madrid.com    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/19 00:53:10 by dyl-syzygy        #+#    #+#             */
/*   Updated: 2025/03/24 22:01:50 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * `flags` structure.
 * It also calls the `ft_handle_width` function to handle the 
 * width specifier
 ...
 * ft_printf function.
 * It sets the space flag bit in the flags structure,
 * indicating that a space
 * should be added before positive signed conversions.
 *
 * @param flags The flags structure to modify.
 * @param args  The variable argument list (unused in this function).
 */
